...
# hobbies
hobbies_train1 = train1$Hobbies_CA_1 + train1$Hobbies_CA_2 + train1$Hobbies_CA_3
hobbies_test1 = test1$Hobbies_CA_1 + test1$Hobbies_CA_2 + test1$Hobbies_CA_3
colnames(hobbies_train1) <- c("hobbies_agg")
colnames(hobbies_test1) <- c("hobbies_agg")
